...
public class mainHopital { 
  ...
  public static void main(String[] args) throws Exception {  
    ...
    //liste de Medicaments - Stock de m�dicaments
    ...
    Medicament m1,m2,m3,m4,m5;
     ...
     System.out.print((i = stm.niveauStock()) + " = niveau du stock de m�dicaments 1");  
     
      
     stm.removeMedicament(m4);
     
     System.out.println(newLine);      
      System.out.print((i = stm.niveauStock()) + " = niveau du stock de m�dicaments 2");      
  ...
  //nouvelle chambre    
    ...
    //Exception sur date de l'op�ration (si la date tombe sur un weekend)__________________
    System.out.println(newLine);
    System.out.println("**Exception sur la date de l'op�ration :");
    ...
    //calul le nombre d'heures travaill�es_______________________________-
    HoraireTravail ht = new HoraireTravail(1,240,"01/10/2020","02/10/2020", "02/10/2020","08:00","10:15","13:00","18:25");
    System.out.println("La dur�e travaill�e est: " + ht.nbrHeuresTravaillees());
    ...
    operation1.setGenre("Proth�se du genou");
    ...
    System.out.println("il/elle va avoir comme op�ration : " + patient1.getOperation().getGenre());
     ...
     System.out.println("3�me patient : " + patient3.getPrenom() + " " + patient3.getNom() + " No Patient:" + patient3.getNo());
    ...
    try { 
     ...
     System.out.println("4�me patient (avec Exception) : " + patient4.getPrenom() + " " + patient4.getNom());
    ...
    System.out.println("Le nombre de minutes travaill�es est: " + ht1.nbrHeuresTravaillees());
 ...
 /* public static void afficherStockMedicaments(StockMedicaments stock){
  ...
  static {
    //executer au d�but avant tout le reste - faire des initialisation en dehors de tout
   ...
   {
     //executer � la cr�ation de chaque objet - instanciation du main - appeler quand on fait new
     System.out.println("*******");
    System.out.println("cr�ation de l'objet: ...."); 
    compteur += 1;    
    System.out.println(compteur);
    System.out.println("*******");
    // grande modification pas courte
  }
